...
def analytics_page(request: Request):
    try:
        ...
        try:
            ...
            raise DatabaseError("Failed to fetch analytics data", original_exception=e)
...
def ai_insights_page(request: Request):
    try:
        ...
        try:
            ...
            raise DatabaseError("Failed to fetch insight data", original_exception=e)
...
def reports_page(
    ...
    try:
        ...
        try:
            ...
            raise DatabaseError("Failed to fetch report data", original_exception=e)
...
def export_reports(
    ...
    try:
        ...
        try:
            ...
            raise DatabaseError("Failed to fetch export data", original_exception=e)
